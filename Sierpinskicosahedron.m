function [V, T] = Sierpinskicosahedron(nb_it, option_display)
%% Sierpinskicosahedron : function compute, display, and save
% a Sierpinski icosahedron at any iteration.
%
